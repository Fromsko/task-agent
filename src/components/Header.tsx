      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center space-x-3 text-xl sm:space-x-8">
            ...
            <Link to="/pricing" className="text-base-content hover:text-primary">
              价格
            </Link>
            <Link to="/download" className="text-base-content hover:text-primary">
              下载
            </Link>
            <Link to="/admin/dashboard" className="text-base-content hover:text-primary">
              仪表盘
            </Link>
